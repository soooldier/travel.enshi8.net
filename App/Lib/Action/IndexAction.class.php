...
class IndexAction extends Action {
    ...
    public function new_features(){
        echo "<h2>新功能测试：</h2>";
        echo "<div>请结合源码观看效果</div>";
        echo "<h3><a href='" . __URL__ . "/sms' target='_blank'>短信预警</a>  <a href='" . __URL__ . "/sae_runtime' target='_blank'>SAE Runtime模式</a>   <a href='" . __URL__ . "/spare_db' target='_blank'>备用数据库</a> </h3>";
    }
